...
jQuery(document).ready(function(){
	junotoys_qrcode_init();
	junotoys_color_picker();
});

function junotoys_qrcode_init() {
...
function junotoys_qrcode_update(widget) {
	junotoys_qrcode_show(widget, {
...
function junotoys_qrcode_show(widget, vc, opt) {
	if (opt.show_what==1) {
...
if (!window.junotoys_set_color_picker) {
	function junotoys_set_color_picker(id_picker) {
		jQuery('#'+id_picker).on('click', function (e) {
			"use strict";
			junotoys_color_picker_show(null, jQuery(this), function(fld, clr) {
				"use strict";
