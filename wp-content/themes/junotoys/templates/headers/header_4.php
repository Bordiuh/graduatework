...
if ( !function_exists( 'junotoys_template_header_4_theme_setup' ) ) {
	add_action( 'junotoys_action_before_init_theme', 'junotoys_template_header_4_theme_setup', 1 );
	function junotoys_template_header_4_theme_setup() {
		junotoys_add_template(array(
			'layout' => 'header_4',
			'mode'   => 'header',
			'title'  => esc_html__('Header 4', 'junotoys'),
			'icon'   => junotoys_get_file_url('templates/headers/images/4.jpg')
			));
	}
}

// Template output
if ( !function_exists( 'junotoys_template_header_4_output' ) ) {
	function junotoys_template_header_4_output($post_options, $post_data) {
		...
		<header class="top_panel_wrap top_panel_style_4 scheme_<?php echo esc_attr($post_options['scheme']); ?>">
			<div class="top_panel_wrap_inner top_panel_inner_style_4 top_panel_position_<?php echo esc_attr(junotoys_get_custom_option('top_panel_position')); ?>">
			<?php
            $is_mega_menu = false;
				...
				<div class="top_panel_top">
					<div class="content_wrap clearfix">
						...
						junotoys_template_set_args('top-panel-top', array(
							'top_panel_top_components' => array('contact_email_phone', 'login', 'cart', 'currency', 'bookmarks')
						));
				...
				<div class="content_wrap">
					<div class="columns_wrap">
						...
						<div class="menu_main_wrap column-3_4">
							<?php
							if (junotoys_get_custom_option('show_search')=='yes') 
